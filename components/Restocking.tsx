    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-950 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    className="absolute top-[-10%] left-[-10%] w-[40rem] h-[40rem] bg-emerald-600/10 rounded-full md:blur-[100px] blur-[60px]"
                    style={{
                ...
                />
                <motion.div
                    className="absolute bottom-[-10%] right-[-10%] w-[40rem] h-[40rem] bg-teal-600/10 rounded-full md:blur-[100px] blur-[60px]"
                    style={{
                        transform: 'translateZ(0)',
                        backfaceVisibility: 'hidden',
                        perspective: 1000
